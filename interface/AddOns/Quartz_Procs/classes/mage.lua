...
function QuartzProcs:returnProcList()
	local tmplist = {
		...
		-- Missile Barrage
		--[string.lower(GetSpellInfo(54486))] = { color={1,0,0.5}, name=GetSpellInfo(54486), },
		-- Icy Veins
		...
		-- Ice Barrier
		[string.lower(GetSpellInfo(11426))] = { color={0,0,1}, name=GetSpellInfo(11426), },
		-- Ice Block
		...
		-- Combustion
		[string.lower(GetSpellInfo(11129))] = { color={1,0.5,0}, name=GetSpellInfo(11129), },
		
		
		--Arcane Missiles!
		[string.lower(GetSpellInfo(79683))] = { color={1,0,0.5}, name=GetSpellInfo(79683), },
