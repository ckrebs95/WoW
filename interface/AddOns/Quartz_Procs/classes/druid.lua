...
function QuartzProcs:returnProcList()
	local tmplist = {
		...
		-- Tiger's Fury
		[string.lower(GetSpellInfo(5217))] = { color={1,0,0}, name=GetSpellInfo(5217), },
		-- Cat Dash
		[string.lower(GetSpellInfo(1850))] = { color={0,1,0}, name=GetSpellInfo(1850), },
		-- Owklin Frenzy
		[string.lower(GetSpellInfo(48391))] = { color={0.7, 0.1, 0.1}, name=GetSpellInfo(48391), },
		-- StarFall
		[string.lower(GetSpellInfo(50288))] = { color={0.125, 0.698, 0.686}, name=GetSpellInfo(50288), },
		-- Enrage
		...
		-- Tree of Life 72,177,204
		[string.lower(GetSpellInfo(33891))] = { color={0.28, 0.69, 0.8}, name=GetSpellInfo(33891), }, 
