...
L:SetOptionLocalization({
	...
	RangeFrame				= "거리 창이 필요하게 될 경우 자동으로 보기",
	yellScrewed				= "$spell:83099 와 $spell:92307 주문의 영향을 동시에 받은 경우 대화로 알리기",
	InfoFrame				= "$spell:83581 또는 $spell:83500 효과 없음에 대한 정보 창 보기",
...
L:SetOptionLocalization({
	...
	InfoFrame				= "$journal:3165 정보 창 보기",
	RangeFrame				= "$spell:82235 주문의 영항을 받은 경우 거리 창(5m) 보기",
